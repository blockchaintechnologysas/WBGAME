...
// Opt 5000 Red Scolcoin (Scol wei Chain) direccion: 0x01667E6fedBF020df3C51EB70Ab8420194332a8b
//*********************************************************************
// BLOCKCHAIN TECHNOLOGY SOLUTIONS AND ARTIFICIAL INTELLIGENCE AI S.A.S
//*********************************************************************
//# locked 12 meses Fondo(1%), para el Medio Ambiente de WB GAME METAVERSO
...
// File: contracts/ecoduende.sol


pragma solidity ^0.8.0;


contract Ecoduende_WBGAME {
    ...
    function retirarTokens() external soloPropietario {
